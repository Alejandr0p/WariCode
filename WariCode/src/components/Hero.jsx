      ...
      <div className="container mx-auto px-6 z-10 relative flex flex-col items-center justify-center h-full">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <motion.p
            ...
            className="text-slate-600 text-lg md:text-2xl font-medium max-w-3xl mx-auto mb-10 md:mb-12 leading-relaxed px-4 md:px-0"
          >
            Ingeniería de la <span className="font-extrabold text-blue-700/60">UNI</span> para elevar tu potencial. Software de élite para clínicas, gimnasios y empresas que buscan <span className="font-extrabold text-blue-700/60">llegar más allá de las nubes.</span>
          </motion.p>
